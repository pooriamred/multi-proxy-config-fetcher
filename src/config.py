...
class ProxyConfig:
    def __init__(self):
        ...
        initial_urls = [
            ChannelConfig("https://ainita.s3.eu-north-1.amazonaws.com/AinitaServer-1.csv#pooria1"),
            ...
            ChannelConfig("https://yebekhe.site/api/tce/api.php?id=shadoowvpnn&base64=true")
        ]
